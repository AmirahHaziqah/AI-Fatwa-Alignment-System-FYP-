...
def apply_dashboard_polish():
    ...
    .ds-loader-v3-icon {
        ...
        box-shadow: 0 4px 10px rgba(119,51,68,0.2);
    }
    .ds-loader-v3-kicker {
    ...
    .ds-loader-v3-hint {
        font-size: 0.7rem; color: #7a6874; line-height: 1.4; margin-top: 0.1rem;
    }
    .ds-col-label {
    ...
    .ds-qa-preview {
        ...
        box-shadow: 0 3px 10px rgba(119,51,68,0.05);
    }
    .ds-qa-row { margin-bottom: 0.1rem; }
    .ds-qa-divider {
        height: 1px;
    ...
    .ds-qa-a-label { color: #4a7c5c; }
    .ds-qa-text {
        font-size: 0.75rem; line-height: 1.55; border-radius: 8px;
        padding: 0.4rem 0.6rem;
    }
    .ds-qa-q-text {
        background: #fdf0f3; color: #3d1a28; border-left: 3px solid #D44D5C;
    }
    .ds-qa-a-text {
        background: #f0faf5; color: #1a3d2b; border-left: 3px solid #06A77D;
    }
    .ds-qa-model-chip {
        display: inline-block;
        background: #e8f4ef; color: #2a6b4a;
        padding: 0.1rem 0.45rem; border-radius: 999px;
        font-size: 0.58rem; font-weight: 800; margin-left: 0.3rem;
...
with tab1:
    ...
    with review_left:
        ...
        if AI_DATASET_AVAILABLE:
            ...
            <div class='ds-loader-card-v3'>
                <div class='ds-loader-v3-head'>
                    <div class='ds-loader-v3-icon'>📂</div>
                    <div>
                ...
                <div class='ds-loader-v3-hint'>Select a question and model to preview both the question and the AI answer before loading.</div>
            </div>
            """), unsafe_allow_html=True)
        ...
        char_count = len(current_ai_input) if input_has_content else 0
        ...
        <div class='ai-input-card {"ai-input-card--filled" if input_has_content else ""}'>
            ...
            {"<div class='ai-input-preview'>" + html.escape(current_ai_input[:500]) + ("…" if len(current_ai_input) > 500 else "") + "</div>" if input_has_content else ""}
        </div>
        """), unsafe_allow_html=True)
