...
.editorial-line-tight {margin:0.75rem 0 1rem 0;}
    ...
    .workspace-shell,.empty-review-card,.batch-shell,.fatwa-browser-shell,.topic-pick-shell,.history-overview-card,.history-table-shell,.grouped-chart-shell,.chart-panel,.analysis-panel,.sim-lite-shell,.comparison-card{margin-bottom:0.75rem!important;}
